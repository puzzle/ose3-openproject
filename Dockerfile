...
ENV OPENPROJECT_VERSION v7.3.2
...
RUN rm -r /opt/rh/rh-nodejs8/root/usr/lib/node_modules/npm/node_modules/columnify
RUN rm -r /opt/rh/rh-nodejs8/root/usr/lib/node_modules/npm/node_modules/read
